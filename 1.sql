...
-- Departments table (created before Doctors to avoid circular FK issue)
...
-- Now update Departments to reference Doctors (after Doctors exists)
ALTER TABLE Departments 
ADD CONSTRAINT fk_head_doctor FOREIGN KEY (head_doctor_id) REFERENCES Doctors(doctor_id);
...
CREATE TABLE Admissions (
    ...
    admitted_by INT, -- can reference staff_id or doctor_id, but can't enforce both
    reason TEXT,
